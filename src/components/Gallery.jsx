import { galleryConfig1, COLORS } from "../config";
import { Swiper, SwiperSlide } from 'swiper/react';
import { Autoplay } from 'swiper/modules';
import 'swiper/css';

function Gallery() {
  const { images } = galleryConfig1;
  return (
    <section className="w-full flex flex-col items-center justify-center mt-4 mb-12 px-2 bg-white">
      <div className="relative w-full max-w-full flex flex-row gap-2 overflow-hidden min-h-[220px] lg:min-h-[420px]">
        <Swiper
          ...
          spaceBetween={8}
          loop={true}
          autoplay={{ delay: galleryConfig1.autoplayDelay, disableOnInteraction: false }}
          breakpoints={{
